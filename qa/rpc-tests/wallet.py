...
#   c) node1 mines 32 blocks, so now node 0 has 500000TESB, node 1 has 4250TESB, node2 has none.
#   d) node0 sends 601 TESB to node2, in two transactions (301 TESB, then 300 TESB).
