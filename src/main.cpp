...
#if defined(NDEBUG)
#error "TesHub cannot be compiled without assertions."
#endif
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // TESB: We use certain sporks during IBD, so check to see if they are
