...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TesHub features */
        {"teshub", "masternode", &masternode, true, true, false},
        {"teshub", "listmasternodes", &listmasternodes, true, true, false},
        {"teshub", "getmasternodecount", &getmasternodecount, true, true, false},
        {"teshub", "masternodeconnect", &masternodeconnect, true, true, false},
        {"teshub", "masternodecurrent", &masternodecurrent, true, true, false},
        {"teshub", "masternodedebug", &masternodedebug, true, true, false},
        {"teshub", "startmasternode", &startmasternode, true, true, false},
        {"teshub", "createmasternodekey", &createmasternodekey, true, true, false},
        {"teshub", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"teshub", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"teshub", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"teshub", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"teshub", "getmasternodescores", &getmasternodescores, true, true, false},
        {"teshub", "mnbudget", &mnbudget, true, true, false},
        {"teshub", "preparebudget", &preparebudget, true, true, false},
        {"teshub", "submitbudget", &submitbudget, true, true, false},
        {"teshub", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"teshub", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"teshub", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"teshub", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"teshub", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"teshub", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"teshub", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"teshub", "checkbudgets", &checkbudgets, true, true, false},
        {"teshub", "mnsync", &mnsync, true, true, false},
        {"teshub", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> teshub-cli " + methodname + " " + args + "\n";
}
