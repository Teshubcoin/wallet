                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TesHub Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TESB address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and teshub: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TesHub Core"), this);
    aboutAction->setStatusTip(tr("Show information about TesHub Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TesHub"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TESB addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TESB addresses"));
    ...
    openAction->setStatusTip(tr("Open a teshub: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TesHub Core help message to get a list with possible TesHub command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TesHub Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TesHub network", "", count));
}
...
{
    QString strTitle = tr("TesHub Core"); // default title
