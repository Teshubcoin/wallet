...
/** Utility functions used by the TesHub Qt UI.
 */
namespace GUIUtil
{
...
// Render TESB addresses in monospace font
...
// Parse "teshub:" URI into recipient object, return true on successful parsing
