...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TesHub Core teshub-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  teshub-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded teshub transaction") + "\n" +
                               "  teshub-tx [options] -create [commands]   " + _("Create hex-encoded teshub transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded teshub transaction
