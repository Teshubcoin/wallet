...
In order to support loading of multiple wallets in teshub-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is teshub.cpp.
...
Changes to teshub.cpp
----------------------
teshub.cpp is the entry point into teshub-qt, and as such, will require some minor modifications to provide hooks for
