...
Intro
-----
TesHub (TESB) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. TesHub utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run teshub-qt.exe.

TesHub Core is the original TesHub client and it builds the backbone of the network.
However, it downloads and stores the entire history of TesHub transactions;
