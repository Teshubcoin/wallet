...
RESOURCES += src/qt/teshub.qrc src/qt/teshub_locale.qrc

TRANSLATIONS += src/qt/locale/teshub_bg.ts \
                src/qt/locale/teshub_de.ts \
                src/qt/locale/teshub_en.ts \
                src/qt/locale/teshub_es.ts \
                src/qt/locale/teshub_fi.ts \
                src/qt/locale/teshub_fr.ts \
                src/qt/locale/teshub_it.ts \
                src/qt/locale/teshub_ja.ts \
                src/qt/locale/teshub_pl.ts \
                src/qt/locale/teshub_pt.ts \
                src/qt/locale/teshub_ru.ts \
                src/qt/locale/teshub_sk.ts \
                src/qt/locale/teshub_sv.ts \
                src/qt/locale/teshub_vi.ts \
                src/qt/locale/teshub_zh_CN.ts \
                src/qt/locale/teshub_zh_TW.ts
