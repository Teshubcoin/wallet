Contributing to TesHub Core
==================================

The TesHub Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TesHub Core project, and is not to be
confused with overall TesHub Network Protocol consensus changes.

Whether a pull request is merged into TesHub Core rests with the project merge
...
Patches that change TesHub consensus rules are considerably more involved than
...
Where a patch set proposes to change the TesHub consensus, it must have been
...
The project leader is the release manager for each TesHub Core release.
